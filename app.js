...
app3.post('/register',function(req,res){
  var phone=req.body.phone;
  var address=req.body.address;
  //data insert code here...
  var sql1 = "INSERT INTO medical_emergency (phone, address) VALUES ('"+phone+"', '"+address+"')";
  con.query(sql1,function(err,result){
    if(err) throw err;
    console.log("Emergency Medical Section Activated...");
    alert("Medical Help On The Way...");
    res.redirect('/');
  });
});
